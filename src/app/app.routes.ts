...
const prefix = environment.client.routePrefix;  // 'awnings' | 'unnamed' | ...
...
export const routes: Routes = [
  ...
  // legacy login path — redirects to prefixed login
  {
    path: 'login',
  ...
  // Root redirect → prefixed dashboard
  { path: '', redirectTo: `${prefix}/dashboard`, pathMatch: 'full' },
  { path: '**', redirectTo: `${prefix}/login` }
];
